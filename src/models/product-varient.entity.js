...
__decorate([
    (0, typeorm_1.Column)({ type: "int" }),
    __metadata("design:type", Number)
], ProductVariant.prototype, "color_id", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "int" }),
    __metadata("design:type", Number)
], ProductVariant.prototype, "size_id", void 0);
__decorate([
...
ProductVariant = __decorate([
    (0, typeorm_1.Entity)({ name: "product_variant" }) // plural or singular, pick consistent naming
], ProductVariant);
